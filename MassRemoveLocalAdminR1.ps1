#Remove-LocalAdmins Massive 
#Modified by: Michael Cotrone
#modified date: 12/27/17
...
#Gets Laps PW of remote machine
$lpassword = Get-AdmPwdPassword -ComputerName $computerName | Select-Object -ExpandProperty Password             

#Attempts to map local machine to remote machine with laps PW
net use \\$computername\ipc$ $lpassword /user:$computerName\administrator                                        
